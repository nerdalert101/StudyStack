...
import { osResources } from '../../data/subjects'
import styles from './OSPage.module.css'

/**
 * OSPage — Resources page for os subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the osresources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <h1 className={styles.pageTitle}>OS</h1>
                <p className={styles.pageSubtitle}>Operating Systems</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · OS</p>
          </div>
        </footer>
      </div>
    </>
