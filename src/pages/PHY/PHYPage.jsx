...
import { phyResources } from '../../data/subjects'
import styles from './PHYPage.module.css'

/**
 * PHYPage — Resources page for phy subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the phyresources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <h1 className={styles.pageTitle}>PHY</h1>
                <p className={styles.pageSubtitle}>Physics</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className={styles.topSection}>
          <div className="container">
            ...
            <div className={styles.topGrid}>
              {phyResources.topLinks.map((item) => (
                <button
                  key={item.id}
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · PHY</p>
          </div>
        </footer>
      </div>
    </>
