...
import { oopsResources } from '../../data/subjects'
import styles from './OOPSPage.module.css'

/**
 * OOPSPage — Resources page for oops subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the oopsresources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <p className={styles.pageSubtitle}>Object-Oriented Programming</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className={styles.topSection}>
          <div className="container">
            ...
            <div className={styles.topGrid}>
              {oopsResources.topLinks.map((item) => (
                <button
                  key={item.id}
        ...
        <section className={styles.unitsSection}>
          <div className="container">
            ...
            <div className={styles.unitsGrid}>
              {oopsResources.units.map((unit, i) => (
                <div
                  key={unit.id}
                  className="fade-up"
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · OOPS</p>
          </div>
        </footer>
      </div>
    </>
