...
import { dsResources } from '../../data/subjects'
import styles from './DSPage.module.css'

/**
 * DSPage — Resources page for ds subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the dsresources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <h1 className={styles.pageTitle}>DS</h1>
                <p className={styles.pageSubtitle}>Data Structures</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · DS</p>
          </div>
        </footer>
      </div>
    </>
