...
import { daaResources } from '../../data/subjects'
import styles from './DAAPage.module.css'

/**
 * DAAPage — Resources page for daa subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the daaResources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <h1 className={styles.pageTitle}>DAA</h1>
                <p className={styles.pageSubtitle}>Design and Analysis of Algorithms</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className={styles.topSection}>
          <div className="container">
            ...
            <div className={styles.topGrid}>
              {daaResources.topLinks.map((item) => (
                <button
                  key={item.id}
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · DAA</p>
          </div>
        </footer>
      </div>
    </>
