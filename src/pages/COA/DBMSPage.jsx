...
import { coaResources } from '../../data/subjects'
import styles from './COAPage.module.css'

/**
 * COAPage — Resources page for COA subject.
 *
 * To add links:
 *   Open src/data/subjects.js and update the coaResources object.
 *
    ...
    <>
      ...
      <div className="page">
          ...
          <div className={`container ${styles.headerInner}`}>
            ...
            <div className={styles.titleRow}>
              ...
              <div>
                ...
                <h1 className={styles.pageTitle}>COA</h1>
                <p className={styles.pageSubtitle}>Computer Organization and Architecture</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className={styles.topSection}>
          <div className="container">
            ...
            <div className={styles.topGrid}>
              {coaResources.topLinks.map((item) => (
                <button
                  key={item.id}
        ...
        <footer className={styles.footer}>
          <div className="container">
            <p>Engineering Resource Hub · COA</p>
          </div>
        </footer>
      </div>
    </>
